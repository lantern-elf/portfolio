    ...
    <>
      ...
      <main className='min-h-[94vh] grid lg:place-items-center' >
        <div className='lg:w-[45%] flex flex-col lg:gap-1 lg:py-1 sm:py-2'>
          <img src="image/illustrations/low angle.webp" alt="" className='select-none pointer-events-none' />
          <img src="image/illustrations/sunken city.webp" alt="" className='select-none pointer-events-none' />
